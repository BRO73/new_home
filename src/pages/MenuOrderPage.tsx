...
// import { MenuItem, Table, CategoryResponse } from "@/types/index";
...
//
//         if (table.status.toLowerCase() !== "available" && table.status.toLowerCase() !== "occupied") {
//           setError(
...
//   const displayCategories = categories.length > 0 ? categoryList : fallbackCategories;
//
...
//   const handleAddToCartWithDetail = (item: MenuItem, quantity: number, note?: string) => {
//     if (item.status.toLowerCase() !== "available") return;
//
//     setAddingToCart(item.id);
//     addToCart(
