    ...
    <section className="py-20 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-5 pointer-events-none">
        <svg className="absolute top-20 right-20 w-64 h-64" viewBox="0 0 200 200">
          <path d="M100,40 L100,160 M60,100 L140,100" stroke="currentColor" strokeWidth="1" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="relative animate-scale-in">
            ...
            <div className="relative rounded-[4rem] overflow-hidden shadow-dish hover-scale">
              <img src={heroDish} alt="Welcome dish" className="w-full aspect-square object-cover" />
            </div>
